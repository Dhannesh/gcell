...
<div class="hero-content">
    ...
    <label for="gtype" class="col-sm-4 col-form-label">Full Name</label>
    <div class="col-sm-8">
     <input type="text" class="form-control" readonly value="<?=$viewmodel['fullname']?>">
    </div>
    </div>
    ...
    <div class="form-group row">
    <label for="status" class="col-sm-4 col-form-label">Select Complaint Status</label>
    <div class="col-sm-8">
